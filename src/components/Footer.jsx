    ...
    <div>
        <div className='grid grid-cols-3 bg-gray-300 mb-6 py-12'>
            ...
            <div className='text-center'>
                ...
                <div className='text-sm text-gray-500 my-3'> The CRSP service provides best accountants</div>
            ...
            <div className='text-center'>
                ...
                <ul className='flex-col'>
                    <li className='text-sm text-gray-500 my-3'>About Us</li>
                    <li className='text-sm text-gray-500 my-3'>How it works</li>
                    <li className='text-sm text-gray-500 my-3'>Register as Accountants</li>
                    <li className='text-sm text-gray-500 my-3'>FAQ</li>
                </ul>
            </div>
