...
const Navbar = () => {
  ...
  return (
    <div>
      {/* Desktop Navbar */}
      <nav className=" hidden lg:flex  justify-between items-center text-white text-lg gap-16 relative">
      ...
      {/* Mobile Navbar */}
      <div className="absolute right-5 top-5 lg:hidden bg-gray-700 text-white">
