  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <div className="py-32 mx-8">
        <h1 className="text-6xl font-bold text-center text-blue-700 px-8">
          OUR TEAM
        </h1>
      ...
      <div className="ps-3 pe-6 py-5 flex items-center justify-between gap-15 text-white bg-blue-900 mx-10 mt-5 mb-8">
        <div className="flex flex-col items-center justify-center pt-10">
          ...
          <div>
            <h3 className="text-3xl font-bold my-5">OMAR HASSAN</h3>
     ...
     <div className="ps-3 pe-6 py-5 flex items-center justify-between gap-15 mx-10 my-8">
