      ...
      <div className="grid grid-cols-2">
        ...
        <div className="bg-gray-200 flex flex-col justify-center items-center drop-shadow-lg px-8 py-8">
          ...
          <div className="flex items-center justify-between w-full gap-10">
            <input type="text" className="shadow-md rounded-md w-full px-5 py-5 my-8 bg-white" placeholder="Name"/>
            <input type="text" className="shadow-md rounded-md w-full px-5 py-5 my-8 bg-white" placeholder="Email"/>
        </div>
        <div className="flex items-center justify-between w-full gap-10">
            <input type="text" className="shadow-md rounded-md w-full px-5 py-5 my-8 bg-white" placeholder="Phone Number"/>
            <input type="text" className="shadow-md rounded-md w-full px-5 py-5 my-8 bg-white" placeholder="Designation"/>
        </div>
        <div className="flex items-center justify-between w-full gap-10">
